...
bool validWidgetName(const string name) @safe
{
...
bool validComposedWidgetName(const string name) @trusted
{
...
T widgetInitProperty(T)(ref YAMLNode yaml, string name) @safe
{
    return property!(T, WidgetInitException)(yaml, name);
}

/// Parse a non-optional layout property at layout initialization.
T layoutInitProperty(T)(ref YAMLNode yaml, string name) @safe
{
...
T styleInitPropertyOpt(T)(ref YAMLNode yaml, string name, auto ref T defValue) @safe
{
...
T widgetInitPropertyOpt(T)(ref YAMLNode yaml, string name, auto ref T defValue) @safe
{
...
T property(T, E)(ref YAMLNode yaml, string name) @safe
{
    try
    {
...
T optionalProperty(T, E)(ref YAMLNode yaml, string name, ref T defValue) @safe
{
    try 
    {
